 ...
 * @author Peter Scully
 */
public class HttpObject_POST extends HttpRequestDataObject  {
    ...
    // ---- Initialisation
    // =========================================================================
    public HttpObject_POST(String line0, BufferedReader br) throws IOException {
        //System.out.println("DO  POST:\t"+Arrays.toString(line0.split(" ")));
        
        this.line0      = line0;
        parseLine0(line0);
        
        if( method.compareTo("POST") != 0){
            System.err.println("Header File Format Error. POST expected, but was missing in line: " + line0);
        ...
        if(! connection.startsWith("Connection: close")){
            System.err.println("FATAL Header File Format Error. POST failed to finish correctly: "+line0+"("+connection+")");
            throw new IOException();
        }
    ...
    // ---- Parsers
    // =========================================================================    
    /** Return method (e.g. "POST"). Should always be "POST". If not there is some problem.
     * @param line
     * @return 
     */
    ...
    private void parsePayload() {
        ...
        if(contentLength.startsWith("Content-Length: ")){
            ...
            if( payloadLengthVal < 0 ){
                System.err.println("FATAL Header File Format Error. POST Content-Length line invalid: "+line0+"("+contentLength+")");
            }
            else{
                //System.out.println("LEN POST:\t"+payloadLengthVal);
                //if(payloadString.contains("=")){
                    //System.out.println("CON POST:\t"+payloadString+"\t"+Arrays.toString(payloadString.split("&")));
                //}
            }
        }
    }
